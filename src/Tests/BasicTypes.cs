...
namespace Tests
{
    internal class BasicTypesClass : IEquatable<BasicTypesClass>
    {
        ...
        public bool Equals(BasicTypesClass other)
        {
            return Equals(StringProperty, other.StringProperty) &&
              ...
              TimeSpan.Equals(TimeSpanProperty, other.TimeSpanProperty) &&
              Equals(DateOnlyProperty, other.DateOnlyProperty) &&
              Equals(TimeOnlyProperty, other.TimeOnlyProperty) &&
    ...
    public class BasicTypes
    {
        ...
        [Fact(DisplayName = "DateOnly - No differences")]
        public void DateOnlyNoDifferences()
        {
            var left = new BasicTypesClass { DateOnlyProperty = DateOnly.MinValue };
            var right = new BasicTypesClass { DateOnlyProperty = DateOnly.MinValue };
        ...
        [Fact(DisplayName = "DateOnly - One difference")]
        public void DateOnlyOneDifference()
        {
            var left = new BasicTypesClass { DateOnlyProperty = DateOnly.MinValue };
            var right = new BasicTypesClass { DateOnlyProperty = DateOnly.MaxValue };
        ...
        [Fact(DisplayName = "DateOnly - Patching difference")]
        public void DateOnlyPatchingDifference()
        {
            var left = new BasicTypesClass { DateOnlyProperty = DateOnly.MinValue };
            var right = new BasicTypesClass { DateOnlyProperty = DateOnly.MaxValue };
        ...
        [Fact(DisplayName = "TimeOnly - No differences")]
        public void TimeOnlyNoDifferences()
        {
            var left = new BasicTypesClass { TimeOnlyProperty = TimeOnly.MinValue };
            var right = new BasicTypesClass { TimeOnlyProperty = TimeOnly.MinValue };
        ...
        [Fact(DisplayName = "TimeOnly - One difference")]
        public void TimeOnlyOneDifference()
        {
            var left = new BasicTypesClass { TimeOnlyProperty = TimeOnly.MinValue };
            var right = new BasicTypesClass { TimeOnlyProperty = TimeOnly.MaxValue };
        ...
        [Fact(DisplayName = "TimeOnly - Patching difference")]
        public void TimeOnlyPatchingDifference()
        {
            var left = new BasicTypesClass { TimeOnlyProperty = TimeOnly.MinValue };
            var right = new BasicTypesClass { TimeOnlyProperty = TimeOnly.MaxValue };
